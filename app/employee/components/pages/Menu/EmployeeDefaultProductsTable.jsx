...
const EmployeeDefaultProductsTable = ({
  data,
  ...
  const columns = [
      ...
      cell: ({ row }) => {
        ...
        return (
          <div className="text-center">
            {!rowData.shapeName ? "Default Shape" : rowData.shapeName}
          </div>
        );
      },
    },
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return (
          <div className="text-center">
            {formatter.format(rowData.default_total)}
          </div>
        );
      },
    },
...
export default EmployeeDefaultProductsTable;
