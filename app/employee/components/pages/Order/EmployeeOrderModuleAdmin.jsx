...
import EmployeeOrderTableAdmin from "./EmployeeOrderTableAdmin";
...
const EmployeeOrderModuleAdmin = ({ userId }) => {
...
export default EmployeeOrderModuleAdmin;
