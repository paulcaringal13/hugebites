...
const EmployeeCustomizationFlavorsTable = ({
  data,
  openEditFlavor,
  openRemoveFlavor,
  openRelaunchFlavor,
  ...
  const columns = [
    ...
    {
      header: "Flavor Category",
      id: "categoryId",
      cell: ({ row }) => {
        const rowData = row.original;
        return <div className="text-center">for {rowData.categoryName}</div>;
      },
    },
    {
...
export default EmployeeCustomizationFlavorsTable;
