...
import EmployeeEditPackagingForm from "./EmployeeEditPackagingForm";

const EmployeePackagingTable = ({
  data,
...
export default EmployeePackagingTable;
