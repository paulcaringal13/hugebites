...
const PackagingReport = ({ userData, reportType }) => {
          ...
          <Bar
            options={{
              ...
              plugins: {
                title: {
                  display: true,
                  text: `Top Packaging ${dayjs(startDate).format(
                    "MMM YYYY"
            ...
            data={{
              labels: reportDatas.map((i) => i.productNameWithSize), // ['prod1', 'prod2']
              datasets: [
                {
                  label: "Sales",
                  data: reportDatas.map((i) => i.totalOrders), // ['80', '70']
                  backgroundColor: [
                    "#5FBDFF",
                    "rgba(2,138,136, 0.6)",
                    "rgba(255, 205, 86, 0.6)",
