...
const AddOnsReport = ({ userData, reportType }) => {
          ...
          <Bar
            options={{
              ...
              plugins: {
                title: {
                  display: true,
                  text: `Top Add Ons ${dayjs(startDate).format(
                    "MMM YYYY"
            ...
            data={{
              labels: reportDatas.map((i) => i.addOnsName), // ['prod1', 'prod2']
              datasets: [
                {
                  label: "Sales",
                  data: reportDatas.map((i) => i.totalAddOnsQuantity), // ['80', '70']
                  backgroundColor: [
                    "#5FBDFF",
                    "rgba(2,138,136, 0.6)",
                    "rgba(255, 205, 86, 0.6)",
